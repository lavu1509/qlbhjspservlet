...
<html lang="en">
    <head>
        ...
        <title>Quản lý hóa đơn - Danh sách</title>
                    ...
                    <tbody>
                        <c:forEach items="${listb}" var="o">
                            <tr>
                                ...
                                <td>
                                    <a href="chitiethoadon?billid=${o.billID}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
