    ...
    <header class="header shop">
        ...
        <div class="container">
            <div class="table-wrapper">
                    ...
                    <tbody>
                        <c:forEach items="${listp}" var="o">
                            <tr>
                                ...
                                <td>
                                    <a href="loadp?pid=${o.pid}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="deletep?pid=${o.pid}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <div class="clearfix">
                    <div class="hint-text">Hiển thị <b>1-5</b> trong <b>${count}</b></div>
                    <ul class="pagination">
